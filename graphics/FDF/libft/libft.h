...
int				ft_sqrt(int n);
t_coord			ft_cadd(t_coord z1, t_coord z2);
t_coord			ft_ccos(t_coord z);
t_coord			ft_cdiv(t_coord dividende, t_coord diviseur);
t_coord			ft_cmult(t_coord z1, t_coord z2);
t_coord			ft_conj(t_coord z);
t_coord			ft_coord(double x, double y);
t_coord			ft_cpow(t_coord z, int n);
t_coord			ft_cremove(t_coord z1, t_coord z2);
double			ft_cnorme(t_coord b);
